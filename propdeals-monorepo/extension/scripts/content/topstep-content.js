/**
 * TopStepFX Content Script
 * Automatically applies PropDeals discount code on TopStepFX checkout pages
 */
...
(function() {
  ...
  const CONFIG = {
    firmName: 'TopStepFX',
    firmId: 'topstep',
    affiliateCode: 'PROPDEALS20',
    checkoutUrls: [
      'https://www.topstepfx.com/checkout'
    ],
    selectors: {
      codeField: "#promo_code, input[name='promo_code']",
      applyButton: "button#apply_promo, .promo-apply"
    },
    retryAttempts: 3,
    retryDelay: 2000,
    observerDelay: 1000,
    ...
    try {
      ...
      if (buttonClicked) {
        ...
        showToast({
          ...
          message: `${CONFIG.affiliateCode} has been applied to your TopStepFX checkout.`,
          type: 'success',
          duration: 5000
        });
