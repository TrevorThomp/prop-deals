/**
 * The5ers Content Script
 * Automatically applies PropDeals discount code on The5ers checkout pages
 */
...
(function() {
  ...
  const CONFIG = {
    firmName: 'The5ers',
    firmId: 'the5ers',
    affiliateCode: 'PROPDEALS8',
    checkoutUrls: [
      'https://www.the5ers.com/checkout'
    ],
    selectors: {
      codeField: "#discount_code, input[name='discount']",
      applyButton: "button.apply-discount"
    },
    retryAttempts: 3,
    retryDelay: 2000,
    observerDelay: 1000,
    ...
    try {
      ...
      if (buttonClicked) {
        ...
        showToast({
          ...
          message: `${CONFIG.affiliateCode} has been applied to your The5ers checkout.`,
          type: 'success',
          duration: 5000
        });
