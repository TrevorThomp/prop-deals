/**
 * Apex Trader Funding Content Script
 * Automatically applies PropDeals discount code on Apex checkout pages
 */
...
(function() {
  ...
  const CONFIG = {
    ...
    firmId: 'apex',
    affiliateCode: 'PROPDEALS10',
    checkoutUrls: [
      'https://www.apextraderfunding.com/checkout',
      'https://www.apextraderfunding.com/cart'
    ],
    selectors: {
      codeField: "input[name='coupon'], input[placeholder*='coupon' i], #coupon_code",
      applyButton: "button.apply-coupon, button[name='apply_coupon']"
    },
    retryAttempts: 3,
    retryDelay: 2000,
    observerDelay: 1000,
    ...
    try {
      ...
      if (buttonClicked) {
        ...
        showToast({
          ...
          message: `${CONFIG.affiliateCode} has been applied to your Apex checkout.`,
          type: 'success',
          duration: 5000
        });
