/**
 * MyFundedFutures Content Script
 * Automatically applies PropDeals discount code on MyFundedFutures checkout pages
 */
...
(function() {
  ...
  const CONFIG = {
    ...
    firmId: 'myfundedfutures',
    affiliateCode: 'PROPDEALS12',
    checkoutUrls: [
      'https://www.myfundedfutures.com/checkout',
      'https://my.myfundedfutures.com/checkout'
    ],
    selectors: {
      codeField: "input.coupon_code, input#coupon_code",
      applyButton: "button[name='apply_coupon']"
    },
    retryAttempts: 3,
    retryDelay: 2000,
    observerDelay: 1000,
    ...
    try {
      ...
      if (buttonClicked) {
        ...
        showToast({
          ...
          message: `${CONFIG.affiliateCode} has been applied to your MyFundedFutures checkout.`,
          type: 'success',
          duration: 5000
        });
